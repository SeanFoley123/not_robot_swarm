...
def main():
	...
	margin = 100
	spacing = int((sizex - 2*margin)/sqrt(len(vertex_set.keys())))
	x = 0
	y = 0
	for vertex in vertex_set.keys():
	...
	for start_vertex in vertex_set.keys():
		for end_vertex in vertex_set[start_vertex]:
